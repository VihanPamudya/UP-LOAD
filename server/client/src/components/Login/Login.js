...
const Login = () => {
        ...
        fetch("/login", {
            ...
            .then(data => {
                ...
                if (data.error) {
                    ...
                    M.toast({ html: "User signin succesfully!", classes: 'rounded ,#43a047 green darken-1' });
                    history.push('/')
                }
    ...
    return (
        <div className="background_login" style={{ minHeight: "90vh" }}>
            <div className="login_mycard">
                <div className="card login_auth-card">
                    ...
                    <h6 style={{ marginTop: "20px" }}>
                        <Link to="/reset" className="links_a">Forgot Your Password?</Link>
                    </h6>
                    <h6>
                        Still don't have an account? <Link to="/signup" style={{ color: "#26a69a" }}>here</Link>
                    </h6>
                </div>
